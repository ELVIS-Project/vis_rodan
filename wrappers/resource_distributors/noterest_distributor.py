...
#
# Filename:               vis-rodan/resource_distributors/noterest_distributor.py.py
# Purpose:                NoteRest Indexer Result Distributor
#
...
class VRNoteRestDistributor(RodanTask):
    ...
    name = 'NoteRest Indexer Result Distributor'
    author = "Marina Borsodi-Benson"
    description = "NoteRest Indexer Result Distributor"
    settings = {}
    ...
    def run_my_task(self, inputs, settings, outputs):
        ...
        infile = inputs['NoteRest Indexer Result Distributor'][0]['resource_path']
        outfile = outputs['NoteRest Indexer Result Distributor'][0]['resource_path']
