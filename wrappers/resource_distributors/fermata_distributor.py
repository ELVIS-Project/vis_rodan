...
#
# Filename:               vis-rodan/resource_distributors/fermata_distributor.py.py
# Purpose:                Fermata Indexer Result Distributor
#
...
class VRFermataDistributor(RodanTask):
    ...
    def run_my_task(self, inputs, settings, outputs):
        ...
        infile = inputs['Fermata Indexer Result Distributor'][0]['resource_path']
        outfile = outputs['Fermata Indexer Result Distributor'][0]['resource_path']
